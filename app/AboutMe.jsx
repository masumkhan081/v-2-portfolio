...
import MasumK from "../public/images/mk.png";
...
import SocialProfiles from "./UI-shared/SocialProfiles";
...
export default function AboutMe() {
  ...
  console.log("server side- about", typeof window === "undefined");

  return (
    <div className="h-full px-1.5 pt-2.0 pb-1.0 grid md:grid-cols-2 grid-cols-1 gap-4 bg-slate-200 border-2 border-teal-700 rounded-md">
